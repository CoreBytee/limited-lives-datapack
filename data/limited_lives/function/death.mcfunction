...
execute as @s if entity @s[scores={limited_lives.lives=0}] run title @s subtitle [{"color":"red","text":"You have "},{"color":"dark_red","score":{"name":"@s","objective":"limited_lives.lives"}},{"color":"red","text":" lives remaining!"}]
...
execute as @s if entity @s[scores={limited_lives.lives=2..}] run title @s subtitle [{"color":"red","text":"You have "},{"color":"dark_red","score":{"name":"@s","objective":"limited_lives.lives"}},{"color":"red","text":" lives remaining!"}]
