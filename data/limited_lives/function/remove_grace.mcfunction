...
execute if entity @s[scores={limited_lives.grace_period_seconds=1..60}] run title @s actionbar [{"color":"white","text":"You have "},{"color":"red","score":{"name":"@s","objective":"limited_lives.grace_period_seconds"}},{"color":"white","text":" seconds of grace period left"}]
execute if entity @s[scores={limited_lives.grace_period_seconds=60..}] run title @s actionbar [{"color":"white","text":"You have "},{"color":"red","score":{"name":"@s","objective":"limited_lives.grace_period_minutes"}},{"color":"white","text":" minutes of grace period left"}]
